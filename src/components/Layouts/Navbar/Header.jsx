...
const Header = () => {
  ...
  return (
    <header className="bg-primary-blue fixed top-0 py-2.5 w-full z-10">
      <div className="w-full sm:w-10/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          <Link
            to="/login"
            className="px-3 sm:px-9 py-1.5 text-primary-blue bg-white border font-medium rounded-sm cursor-pointer"
          >
            Login
          </Link>
